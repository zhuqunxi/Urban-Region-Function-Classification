...
train_files_list = ['train_basic_13_RF_1581.npy', 'train_X_UserID_normal_local_day.npy']
test_files_list = ['test_basic_13_RF_1581.npy', 'test_X_UserID_normal_local_day.npy']
...
classifiers = [
    ...
    lgbm.LGBMClassifier(random_state=42, n_jobs=30, n_estimators=600, learning_rate=0.09)
]
