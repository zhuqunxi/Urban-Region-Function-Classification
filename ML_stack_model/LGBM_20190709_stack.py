...
def get_train_test_data(files_list, n_dim, mode='Train'):
    ...
    for X_name in files_list:
        ...
        if X_name == 'pro_LGBM_test_day_20190706.npy':
            tmp /= 5
...
train_files_list = ['pro_LGBM_val_day_20190706.npy', 'PROB_Train.npy']
test_files_list = ['pro_LGBM_test_day_20190706.npy', 'PROB_Test.npy']
